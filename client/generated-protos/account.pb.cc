...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_account_2eproto[4];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_account_2eproto_sccs[4] = {
